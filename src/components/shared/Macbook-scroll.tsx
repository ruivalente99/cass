...
export const MacbookScroll = ({
    ...
    return (
        <div className='md:pt-20 md:pb-80 py-0'>
            <motion.h2
                style={{
            ...
            >
                {title || (
                    ...
                    <div className="mx-auto mb-4 max-w-2xl text-center text-4xl font-bold leading-[1.15] md:text-6xl md:leading-[1.15]">
                        But, what it really
                        <span className="text-orange-600"> does ?</span></div>
                )}
            </motion.h2>
            <div
                ref={ref}
                className="flex flex-col items-center justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.50] sm:scale-50"
            >
                {/* Lid */}
                <Lid
                    src={src}
                ...
                />
                {/* Base area */}
                <div className="h-[22rem] w-[32rem] bg-gray-400 rounded-2xl overflow-hidden relative -z-10">
                    {/* above keyboard bar */}
