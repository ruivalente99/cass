...
export const FeatureToggles = () => {
  ...
  return (
    <section className="relative mx-auto max-w-6xl px-2 md:px-4">
      <SectionHeading>
        We build it for <span className="text-orange-600">you</span>
      </SectionHeading>
      <SectionSubheading>
        <span className="text-orange-600">Our support</span> extends beyond installation. What happens behind the scenes?
      </SectionSubheading>
